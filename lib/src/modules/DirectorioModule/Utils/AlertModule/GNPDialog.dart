...
import 'package:agentesgnp/ThemeGNP/PositiveButton.dart';
...
class GNPDialog extends StatelessWidget {
  ...
  Widget showIcon() {
    if (tipo != null && tipo == TipoDialogo.ADEVERTENCIA) {
      return Image.asset('assets/img/warning.png', width: 30.0, height: 30.0);
    } else if (tipo != null && tipo == TipoDialogo.EXITO) {
      return Image.asset('assets/img/verified.png', width: 30.0, height: 30.0);
    } else {

...
class ContactController extends GetxController with StateMixin<_ContactModel> {
  ...
  List<BreadcrumbWeb> breadcrumbs = [
    ...
    BreadcrumbWeb(msg.gnpContact.tr()),
  ];

  @override
  Future<void> onInit() async {
    super.onInit();
    change(const _ContactModel(), status: RxStatus.loading());
    await getData();
  }
